...
class TestPool(TestCase):
    ...
    def test_create(self):
        """Test that a variable pool can be instantiated."""
        VariablePool()

    def test_get(self):
        """Test that we can get variables from a VariablePool instance."""
        pool = VariablePool()
    ...
    def test_getitem(self):
        """Test that we can get variables using bracket ['x'] notation."""
        pool = VariablePool()
    ...
    def test_getitem_singleton(self):
        """Test that VariablePools return the same variable instance."""
        pool = VariablePool()
    ...
    def test_fresh(self):
        """Test that VariablePools can generate "fresh" variables.
...
class TestFreshVariable(TestCase):
    ...
    def test_fresh_variable(self):
        """Test that fresh_variable works on variables from a pool."""
        pool = VariablePool()
        x = pool['x']
    ...
    def test_indexed_variable(self):
        """Test that fresh_variable works on indexed variables from a pool."""
        pool = VariablePool()
        x = pool['x']
    ...
    def test_fresh_pool(self):
        """Test that fresh_variable works on a VariablePool."""
        pool = VariablePool()
    ...
    def test_fresh_throws(self):
        """Test that fresh_variable throws for non-pool objects.
